    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new HongKetoCoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->hongketocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting HongKetoCoin."), QMessageBox::Ok);
