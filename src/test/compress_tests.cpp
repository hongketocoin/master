...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1HKC 10000

// amounts 6000 .. 600000000
#define NUM_MULTIPLES_50HKC (600000000 / 6000)
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(600000000*COIN, 0x1406f40));
    ...
    for (uint64 i = 1; i <= NUM_MULTIPLES_1HKC; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64 i = 1; i <= NUM_MULTIPLES_50HKC; i++)
