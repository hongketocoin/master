...
**
** Created: Sun May 18 11:16:25 2014
...
#include "hongketocoinamountfield.h"
...
public:
    ...
    HongKetoCoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *hongketocoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new HongKetoCoinAmountField(tabMain);
        ...
        hongketocoinAtStartup = new QCheckBox(tabMain);
        hongketocoinAtStartup->setObjectName(QString::fromUtf8("hongketocoinAtStartup"));

        verticalLayout_Main->addWidget(hongketocoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        hongketocoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start HongKetoCoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        hongketocoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start HongKetoCoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the HongKetoCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the HongKetoCoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting HongKetoCoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show HongKetoCoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
